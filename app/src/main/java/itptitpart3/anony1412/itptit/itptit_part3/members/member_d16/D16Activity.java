...
public class D16Activity extends AppCompatActivity {

    private ArrayList<Member> membersD16 = new ArrayList<>();
    private RecyclerView rvD16;
    ...
    private void init() {
        ...
        rvD16 = findViewById(R.id.rvD16Members);
        adapter = new D16Adapter(this, membersD16);
        rvD16.setAdapter(adapter);
        LinearLayoutManager layoutManagerD16 = new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false);
        rvD16.setLayoutManager(layoutManagerD16);
    }
