...
public class D12Adapter extends RecyclerView.Adapter<D12Adapter.ViewHolder> {

    private Context context;
    private ArrayList<Member> membersD12;
    private LayoutInflater inflater;

    public D12Adapter(Context context, ArrayList<Member> objects) {
        this.context = context;
        this.membersD12 = objects;
    ...
    @Override
    public D12Adapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return ( new D12Adapter.ViewHolder(view));
    }

    @Override
    public void onBindViewHolder(final D12Adapter.ViewHolder holder, final int position) {
        final Member member = membersD12.get(position);
