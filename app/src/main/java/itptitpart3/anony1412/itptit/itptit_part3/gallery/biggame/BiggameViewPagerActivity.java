...
public class BiggameViewPagerActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {

    ViewPager viewPager;
    CircleIndicator indicator;
    BiggameFragmentAdapter adapter;
    ...
    private void init() {
        adapter = new BiggameFragmentAdapter(getSupportFragmentManager());
